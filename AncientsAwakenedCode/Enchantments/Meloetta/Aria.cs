...
public class Aria : CustomEnchantmentModel
{
    ...
    protected override IEnumerable<DynamicVar> CanonicalVars => [new DamageVar(6M, ValueProp.Move), new PowerVar<StrengthPower>(2)];
    
    protected override IEnumerable<IHoverTip> ExtraHoverTips => [HoverTipFactory.FromPower<StrengthPower>()];

    public override async Task OnPlay(PlayerChoiceContext choiceContext, CardPlay? cardPlay)
    {
        await PowerCmd.Apply<StrengthPower>(choiceContext, Card.Owner.Creature, DynamicVars.Strength.BaseValue, Card.Owner.Creature, Card);
    }
