...
public class RelicSong() : AncientsAwakenedRelic
{
    ...
    protected override IEnumerable<IHoverTip> ExtraHoverTips => HoverTipFactory.FromCardWithCardHoverTips<Crescendo>().Concat(HoverTipFactory.FromCardWithCardHoverTips<Diminuendo>());
